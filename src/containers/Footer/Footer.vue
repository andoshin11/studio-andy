<template>
  <div class="Footer">
    <div class="socialLinks">
      <a class="socialLink" href="https://twitter.com/andoshin11" target="_blank" aria-label="Twitter Link" rel="noopener">
      ...
      <a class="socialLink" href="https://github.com/andoshin11" target="_blank" aria-label="GitHub Link" rel="noopener">
        <svg aria-hidden="true" data-prefix="fab" data-icon="github" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 496 512">
          <path
    ...
    <div class="copyright" role="button" @keydown="debugError" @click="debugError">Copyright © 2020 Shin Ando</div>
  </div>
</template>
